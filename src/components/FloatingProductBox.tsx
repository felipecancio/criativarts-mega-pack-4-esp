...
const sizeClasses = {
  ...
  "2xl": "w-full max-w-none sm:max-w-[500px] md:max-w-[560px] lg:max-w-[620px]",
};
...
export default function FloatingProductBox({ className = "", size = "md" }: FloatingProductBoxProps) {
  ...
  return (
    <div className={`relative mx-auto flex w-full flex-col items-center justify-center ${maxW} ${className}`}>
      ...
      >
        <img
          ...
          className="mx-auto block h-auto w-full max-w-full object-contain object-center drop-shadow-[0_12px_32px_rgba(168,85,247,0.25)]"
          draggable={false}
        />
      </motion.div>
    </div>
