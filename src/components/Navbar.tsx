      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20 gap-2 sm:gap-3">
          <div className="flex min-w-0 flex-1 items-center">
            <span className="text-lg font-black leading-none tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-500 sm:text-2xl md:text-3xl">
